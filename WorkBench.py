...
def save_qai():
	...
	with open(QAIs_path,"w") as QAIs_file:
...
def update_configurations():
	...
	with open(configurations_path,"w") as configurations_file:
...
def templates():
	...
	with open(QAIs_path,"r") as templates_file:
...
@app.route("/")
def index():
	with open(configurations_path,"r") as config_file:
